...
public class admin_appointment_details extends AppCompatActivity {
    TextView name_d, phone_d, type_d, additional_d, doctor_d, date_d, time_d, call_btn;
    Button cancel_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(admin_appointment_details.this).setIcon(R.drawable.treatment_icon)
