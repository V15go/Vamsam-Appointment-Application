...
public class arakkonam_appoint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arakkonam_appoint);

        recyclerView = findViewById(R.id.arakkonam_recyclerView);


        Query query = FirebaseFirestore.getInstance().collectionGroup("Your Appointments").whereEqualTo("Doctor", "Arakkonam");
            ...
            protected void onBindViewHolder(@NonNull appointViewHolder holder, int position, @NonNull firebasemodel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getApplicationContext(), admin_appointment_details.class);
